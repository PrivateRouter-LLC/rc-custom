...
opkg install acme attendedsysupgrade-common attr avahi-dbus-daemon base-files busybox ca-bundle certtool cgi-io curl davfs2 dbus ddns-scripts ddns-scripts-cloudflare ddns-scripts-digitalocean

opkg install ddns-scripts-services dnsmasq dropbear firewall fstools fuse3-utils fwtool getrandom git glib2 gnupg hostapd-common ip-full ip6tables ipset iptables iptables-mod-ipopt iw iwinfo jshn
